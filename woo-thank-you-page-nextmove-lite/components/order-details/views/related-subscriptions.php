...
<div class="xlwcty_Box xlwcty_subscription xlwcty_order_details_2_col xlwcty_Box xlwcty_minicart">
    ...
    <div class="xlwcty_title"><?php esc_html_e( 'Related Subscriptions', 'woo-thank-you-page-nextmove-lite' ); ?></div>
    <table class="shop_table shop_table_responsive my_account_orders">
        <thead>
        <tr>
            <th class="order-number xlwcty_left"><span class="nobr"><?php echo esc_html__( 'Subscription', 'woo-thank-you-page-nextmove-lite' ); ?></span></th>
            <th class="order-status xlwcty_center "><span class="nobr"><?php echo esc_html__( 'Next Payment', 'woo-thank-you-page-nextmove-lite' ); ?></span></th>
            <th class="order-total xlwcty_center "><span class="nobr"><?php echo esc_html__( 'Total', 'woo-thank-you-page-nextmove-lite' ); ?></span></th>
            <th class="order-total xlwcty_center "><span class="nobr"><?php echo esc_html__( 'Action', 'woo-thank-you-page-nextmove-lite' ); ?></span></th>
        </tr>
        </thead>
        <tbody>
